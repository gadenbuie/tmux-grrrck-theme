...
main() {
	...
	then
		...
		tmux set-option -g status-left "#[fg=blue]#H #[fg=black,bright]• #[default]#[fg=green]#(whoami)#[default]• #[fg=magenta]#(curl ipinfo.io/ip;echo)#[default]   "
		...
		tmux set-option -g status-left "#[fg=blue] #H #[fg=black]• #[fg=green]#(whoami) #[fg=black]• #[fg=magenta]#(curl ipinfo.io/ip;echo)#[default]  "
		...
		tmux set-option -g status-right "#[fg=yellow,nobright] #($HOME/.tmux/plugins/tmux-net-speed/scripts/net_speed.sh)#[fg=black] • #[fg=magenta]#($HOME/.tmux/plugins/tmux-cpu/scripts/cpu_percentage.sh)#[fg=black] • #[fg=cyan]%H:%M:%S #[default]"
	fi
}
main
